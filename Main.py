...
class MainPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        style_blue.configure(
            "Custom.TButton.Blue", background="light blue", font="Helvetica 18 bold"
        )
        ...
        leaderboard_button = ttk.Button(
            self, text="Leaderboards", style="Custom.TButton.Red"
        )
        leaderboard_button.configure(style="Custom.TButton.Red")
        leaderboard_button.pack(pady=10)

        exit_button = ttk.Button(
            self, text="Exit", style="Custom.TButton.Black", command=self.exit_game
        )
