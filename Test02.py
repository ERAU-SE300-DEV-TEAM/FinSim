...
# Define image
bg = tkinter.PhotoImage(file="CBGR.png")
...
# Add a label
my_canvas.create_text(550, 100, text="Welcome!", font=("Helvetica", 50), fill="Black")
#my_canvas.place(relx=0.5, rely=0.6, anchor=tkinter.CENTER)
